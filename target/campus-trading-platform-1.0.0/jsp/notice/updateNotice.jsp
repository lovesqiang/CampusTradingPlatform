...
<%--        <form action="${ctx}/notice/updateNotice" method="post" class="form-x" enctype="multipart/form-data">--%>
         <form action="${ctx}/notice/updateNotice" method="post" class="form-x">
            <input type="hidden" name="noticeId" value="${notice.noticeId}">
            <div class="form-group">
                <div class="label"><label>公告标题：</label></div>
                <div class="field">
                    <input type="text" class="input w50" name="noticeName" data-validate="required:请输入标题" value="${notice.noticeName}" />
                    <div class="tips"></div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <textarea value="${notice.noticeContent}" rows="10" cols="70" id="content" style="width: 330px;border: 1px solid #ddd;outline: none;height: 159px;text-indent: 10px;"></textarea>
                    <div class="tips"></div>
                </div>
            </div>
